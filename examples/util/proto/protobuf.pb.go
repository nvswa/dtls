...
type ConnInfo struct {
	...
	Covert    *string `protobuf:"bytes,2,opt,name=covert" json:"covert,omitempty"`
...
func (x *ConnInfo) GetCovert() string {
	if x != nil && x.Covert != nil {
		return *x.Covert
	}
	return ""
}

func (x *ConnInfo) GetEarlyData() []byte {
	if x != nil {
		return x.EarlyData
	}
	return nil
...
var file_protobuf_proto_rawDesc = []byte{
	...
	0x12, 0x05, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x51, 0x0a, 0x08, 0x43, 0x6f, 0x6e, 0x6e, 0x49,
	0x6e, 0x66, 0x6f, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52,
	0x02, 0x69, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x74, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x06, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x65,
	0x61, 0x72, 0x6c, 0x79, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52,
	0x09, 0x65, 0x61, 0x72, 0x6c, 0x79, 0x44, 0x61, 0x74, 0x61,
}
